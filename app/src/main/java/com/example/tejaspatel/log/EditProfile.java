                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        for(int i=0;area.length()>i;i++){
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_spinner_item, locationArray); //selected item will look like a spinner set from XML
                        ...
                        for(int i=0;sport.length()>i;i++){
                            ...
                            String name=team.getString("name");
                            sportArray.add(name);
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, sportArray); //selected item will look like a spinner set from XML
                            spinnerArrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
